...
window.OBSERVATORY = {
  ...
  games: [
    ...
    },
    {
      ...
      bucket: "update",
      platformClass: "multi",
      announceDate: "2026-09-24（モバイル版の予約受付を開始）",
      capturedAt: "2026-09-24",
      ...
      highlight: "【2026-09-24 モバイル版予約受付開始】バンダイナムコエンターテインメントが iOS／Android 版の予約受付を開始した（発売はコンシューマ版の翌日、2026-10-23。買い切りのため追加課金なし）。同日、新米スタッフの一日を紹介する「あそびかた紹介 ～新米スタッフの１日～」と、レストラン従業員募集を題材にした 2 本の映像が公開された。　【TGS2026 9/18】バンダイナムコ 综合展台提供含 iOS／Android 版在内的跨平台试玩，未单独划入移动端专区，与《BLEACH Mirrors High》同在主力展位露出；展台还公开了「バラティエ 2 号店」的玩法介绍影像与一份以该店为舞台的架空新人招募影像。　IP 授权经营模拟：把「吃饭」这条原作主线做成核心玩法，而不是又一款战斗手游。",
      console: {
      ...
      news: [
        ...
        { source: "3DM 游戏网（海外媒体／モバイル版の予約受付開始を報道）", url: "https://www.3dmgame.com/news/202609/3954465.html" }
      ],
      videos: [
      ...
      caution: "モバイル版の予約受付開始（2026-09-24）は海外（中国語圏）メディアが報じたバンダイナムコエンターテインメントの発表にもとづくもので、同日時点で日本語の公式サイトでは当該告知を確認できていない。日本語の公式告知を確認でき次第、記載を更新する",
      mobile: {
        status: "2026-10-23 配信予定（主机版は 10-22 先行）。モバイル版の予約受付は 2026-09-24 より開始",
        os: ["iOS", "Android"],
        monetization: "買い切り（モバイル版 2,000 円。追加課金の記載なし）",
        payment: [],
        preReg: { open: true, since: "2026-09-24（iOS／Android 版の予約受付を開始）", reward: "買い切りのため事前登録ではなく予約受付。予約特典の内容は未発表（パッケージ版は数量限定でキャラクター 100 体オリジナルシール、超特装版にルフィのぬいぐるみ等を同梱）" },
