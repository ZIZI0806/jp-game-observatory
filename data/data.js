...
window.OBSERVATORY = {
  ...
  meta: {
    updatedAt: "2026-09-23T09:10:00+08:00",
    edition: "2026-09-23",
  ...
  games: [
    ...
    },
    {
      ...
      highlight: "【TGS2026 9/19】『センチメンタルグラフティ』リメイクのステージで、ヒロイン 6 名の声優と主題歌が発表された。声優は公開オーディション（応募総数 1,864 件）で選出。主題歌は SHAZNA のデビュー曲「Melty Love」の 30 周年アレンジ版で、2027-01-01 にデジタルシングルとして配信される。　原典は 1998 年のセガサターン用恋愛シミュレーション。キービジュアルは原画の 甲斐智久 が描き下ろし、グラフィックと操作性を現代のアドベンチャーゲーム水準に最適化する。発売時期・価格は未公表。",
      console: {
    ...
    },
    {
      ...
      bucket: "update",
      platformClass: "pc",
      announceDate: "2026-09-17（TGS2026 で初のプレイアブル出展。Steam ストアページは 2026-09-03 に公開済み）",
      capturedAt: "2026-09-23",
      title: {
        jp: "ガチ恋監禁♡めるてぃほりっく",
        cn: "真爱监禁♡融化中毒",
        en: "CAPTIVE LOVE♡MELTY HOLIC"
      },
      genre: "脱出サスペンス × 横スクロール探索アドベンチャー（ポイント＆クリック）",
      platforms: ["PC（Steam）"],
      release: "2027年（予定。時期・価格は未発表）",
      releasePrecision: "年",
      summary: "由位于东京都台东区的 SERIALGAMES 自主开发并发行的脱出悬疑×横版探索冒险游戏。主角是地下男性偶像组合的成员 ルイト（犬渊ルイト），被囚禁在陌生的废弃大楼里——抓走他的人正是他自己的狂热粉丝。玩家要在散落着「推活」残骸（与御宅族拍的拍立得、生日活动海报、碎裂的亚克力立牌）的大楼里探索：一边躲避手持钉棒的追迹者 ルナ（一名哭喊着「ずっと信じてきたのに」的长发优雅女子），一边用场景道具解除陷阱推进。躲进储物柜或物体背后只有在距离足够拉开时才有效，游戏不预先提示追迹者位置，被抓到即结束本轮。像素画风、横版配合点击式操作、多重结局，单周目约 5〜10 小时，字幕支持日／英／简中／繁中／韩。作品于 TGS2025 首次公开，2026-09-03 开设 Steam 商店页，TGS2026 首次提供可玩试玩（收录序章与第 1 章部分），预定 2027 年发售。",
      highlight: "【TGS2026 9/17】SERIALGAMES 展台（9 号馆 09-C60）で初のプレイアブル出展。試遊版は序章と第 1 章の一部を収録し、追手ルナ の「ずっと信じてきたのに」「今でもルイトは私の一番」といった叫びが画面を埋める。ロッカーや物陰への潜伏は距離が十分に離れていないと通用せず、追手の位置は事前に知らされない。　作品は TGS2025 で初公開、Steam ストアページは 2026-09-03 に開設済み。「アイドル×ファン」の関係そのものを恐怖の源に据えた切り口が、アニメ・サブカル系メディアで取り上げられている。",
      console: {
        status: "2027年発売予定（時期・価格は未発表）",
        os: ["Windows（Steam）"],
        monetization: "買い切り（価格未発表）",
        developer: "株式会社シリアルゲームズ（SERIALGAMES Inc.／東京都台東区）",
        publisher: "株式会社シリアルゲームズ",
        region: "日本（Steam にて世界配信。日本語・英語・簡体字・繁体字・韓国語の字幕に対応）",
        distribution: "Steam でのダウンロード販売",
        stores: ["Steam"],
        features: [
          "地下アイドルを主人公にした脱出サスペンス。追手が「かつての熱心なファン」という設定で、恐怖の源をアイドルとファンの関係そのものに置いている",
          "横スクロールの探索にポイント＆クリックの操作を組み合わせ、危険な仕掛けの解除とアイテム収集で館内を進む",
          "物陰やロッカーに隠れて追手をやり過ごす。ただし距離が十分に離れていないと隠れきれず、追手の居場所は事前に知らされない",
          "ピクセルアートで描かれたキャラクターと、チェキやフェスグッズなど「推し活の残骸」が散らばる廃ビルの美術",
          "マルチエンドを採用。プレイ時間は約 5〜10 時間と Steam ストアページに記載されている"
        ],
        synopsis: "人気の地下アイドル ルイト は、見知らぬ廃ビルに拉致・監禁されてしまう。行く手を阻む仕掛けと罠、そして容赦なく追いかけてくる熱狂的なファンたち。走って逃げ、必要なときは身を隠し、集めたアイテムで謎を解きながら、狂気の館からの脱出を目指す。",
        ipSource: "完全新作（オリジナル IP）",
        series: "SERIALGAMES は 2000 年設立、東京都台東区に本社を置く日本のゲーム開発・発行会社。スマートフォン向けタイトルのサーバープログラム開発などで実績を持つ。本作は自社発行のオリジナル企画で、企画・監督は 2025 年の初公開時から 星宮和子、キャラクター原画は 宇田川歌子 が担当する",
        cast: "公式発表なし（担当声優は未公表）"
      },
      news: [
        { source: "Automaton（開発・発行とも国内スタジオ SERIALGAMES・病みファン 3 名の設定）", url: "https://automaton-media.com/en/news/escape-game-captive-love%e2%99%a1melty-holic-follows-an-underground-male-idol-running-from-yandere-fangirls/" },
        { source: "Yomimono（4Gamer.net 出典・TGS2026 試遊版の内容と追手ルナの描写）", url: "http://yomimono.id/gachi-koi-kangoku-melty-holic-blends-escape-adventure-with-underground-idol-horror" },
        { source: "RYGAMES Newsroom（Steam ストアページ公開・TGS2026 出展の整理。PR TIMES 出典）", url: "https://rygames.store/en/captive-love-melty-holic-steam-page-tgs-2026" },
        { source: "Steam ストアページ（ウィッシュリスト受付中・2027 年配信予定）", url: "https://store.steampowered.com/app/4996980/" }
      ],
      videos: [
        { label: "TGS2026 試遊版の内容（4Gamer.net 出典のレポート）", platform: "媒体", url: "http://yomimono.id/gachi-koi-kangoku-melty-holic-blends-escape-adventure-with-underground-idol-horror" },
        { label: "Steam ストアページ（ウィッシュリスト受付中）", platform: "Steam", url: "https://store.steampowered.com/app/4996980/" }
      ],
      hype: {
        score: 40,
        signals: [
          "TGS2025 で初公開され、TGS2026 で初のプレイアブル出展に至った国内インディーの企画",
          "「アイドル×病みファン」という題材のネタ性が高く、アニメ・サブカル系の海外メディアでも記事化されている",
          "開発・発行とも国内の小規模スタジオで、価格・発売時期・対応機種の詳細は未発表のため数値シグナルは存在しない"
        ]
      },
      tags: ["PC", "アドベンチャー", "ホラー", "インディー", "TGS2026"]
    },
    {
      ...
      bucket: "update",
      platformClass: "console",
      announceDate: "2026-09-17（TGS2026 の room6 ブースで、序章を追加した試遊版を出展）",
      capturedAt: "2026-09-23",
      title: {
        jp: "狐ト蛙ノ旅 アダシノ島のコトロ鬼",
        cn: "狐与蛙之旅（Kitsune: The Journey of Adashino）",
        en: "Kitsune: The Journey of Adashino"
      },
      genre: "見下ろし型 3D 探索アクションアドベンチャー（和風ダークファンタジー）",
      platforms: ["Nintendo Switch", "PC（Steam）"],
      release: "2026年第4四半期（PC／Mac。Nintendo Switch 版は 2027 年前半の予定）",
      releasePrecision: "季",
      summary: "由插画师 リアス（RIAS）的个人企划发展而来、room6 与 yokaze 发行的和风 3D 探索动作冒险游戏。舞台是被黑暗笼罩、却浮着无数灯火的孤岛「アダシノ島」：狐狸少女与青蛙同伴在岛上迷路，一边与居民对话揭开岛屿秘密、一边躲避恶鬼的追逐寻找归途。核心机制是「光」——狐狸少女点亮的光可让恶鬼暂时停下脚步（有次数限制，可借由点亮祠堂补充），也能照亮看不见的路、向居民打听情报；把收集来的光堆叠起来便凝成「無明の塔」，让化野岛越发妖异。作品于 2022 年 6 月 Summer Game Fest 的 Day of the Devs 环节公布（Switch 与 Steam 双平台），Steam 商店页与免费 Demo 随后开放，Steam 页标注发售窗口为 2026 年第 4 季度。2026 年 TGS 的 room6 展台提供了追加「序章」的新试玩版。",
      highlight: "【TGS2026 9/17】room6 展台で、序章を追加した試遊版を出展。序章は島ではなく狐少女の部屋から始まり、ブラウン管テレビと黒いダイヤル式電話、滞納した電気代、扉を叩く音と停電、コンビニでの支払い、隣の神社の賽銭回収、提灯型の付喪神による神社の持ち去り、穴と暗渠と係留船を経てアダシノ島へ至る流れが収録される。　作品は 2022 年 6 月の Summer Game Fest「Day of the Devs」で Switch／Steam 向けとして初公開され、企画から約 10 年をかけて制作が続く個人開発作。序章が加わったことは、開幕部分を磨ける完成度に達したことを示す。",
      console: {
        status: "2026年第4四半期 発売予定（PC／Mac）。Nintendo Switch 版は 2027 年前半の予定",
        os: ["Nintendo Switch", "Windows／macOS（Steam）"],
        monetization: "買い切り（価格未発表。Steam では無料デモを配信中）",
        developer: "リアス（Rias・個人開発）",
        publisher: "株式会社room6／ yokaze",
        region: "日本（世界配信。日本語・英語・簡体字・繁体字に対応）",
        distribution: "ダウンロード版（Nintendo eShop／Steam）",
        stores: ["Nintendo eShop", "Steam"],
        features: [
          "闇に包まれた島を狐の少女と蛙が歩く、見下ろし型の 3D 探索アドベンチャー",
          "探索と「鬼ごっこ」の 2 つが軸。島の住民と会話して秘密を解き、祠堂に灯をともすと探索できる範囲が増える",
          "鬼に追われたときは、狐の少女の「光」で鬼の足を一時的に止める。光の使用には回数制限があり、祠堂で補充する",
          "光は見えない道を照らしたり、住民から情報を引き出したりするのにも使える",
          "集めた光を積み上げて築かれる「無明の塔」が、アダシノ島と物語の中心に据えられている",
          "TGS2026 の room6 ブースでは、島に至るまでの経緯を描く序章を収録した試遊版を出展"
        ],
        synopsis: "狐の少女と蛙は、闇夜に多くの灯が浮かぶ不思議な島に流れ着く。鳥居や屋台の提灯、ネオンの看板に彩られた島の影には、人ならざる存在が潜んでいる。少女が灯す光を使い、闇に潜むものの手から逃れ、物陰に隠れながら次に進むべき道を照らしていく。今宵は十五夜、夏の終わりの長い一夜の物語。",
        ipSource: "リアス（Rias）の個人企画を原作とする完全新作（オリジナル IP）",
        series: "リアス が個人で描き続けてきた画作を起点に、2022 年 6 月の Summer Game Fest「Day of the Devs」で Switch／Steam 向けとして発表された。以後、Steam ストアページと無料デモが公開され、発売は Steam 上で 2026 年第 4 四半期と表示されている",
        cast: "公式発表なし（担当声優は未公表）"
      },
      news: [
        { source: "Yomimono（4Gamer.net 出典・TGS2026 room6 ブースの序章追加試遊版）", url: "https://www.yomimono.id/kitsune-to-kaeru-no-tabi-adds-prologue-sequence-ahead-of-early-2027-release" },
        { source: "公式サイト（狐ト蛙ノ旅 アダシノ島のコトロ鬼）", url: "http://foxandfrog.net/" },
        { source: "Steam ストアページ（2026 年第 4 四半期配信予定・簡体字／繁体字対応）", url: "https://store.steampowered.com/app/2065580/Kitsune_The_Journey_of_Adashino/" }
      ],
      videos: [
        { label: "Steam ストアページ（トレーラーとスクリーンショット・無料デモ配信中）", platform: "Steam", url: "https://store.steampowered.com/app/2065580/Kitsune_The_Journey_of_Adashino/" },
        { label: "公式サイト（作品紹介と映像）", platform: "官方站", url: "http://foxandfrog.net/" }
      ],
      hype: {
        score: 42,
        signals: [
          "2022 年の Summer Game Fest「Day of the Devs」での初公開以来、企画から約 10 年をかけた個人開発作として注目が続いている",
          "room6 は国内インディーを数多く手がける京都のパブリッシャーで、Steam では無料デモを配信して事前の接触を作っている",
          "TGS2026 で序章を追加した試遊版を出展し、発売前の露出を積み上げている段階で、具体的な発売日と価格は未発表"
        ]
      },
   ...
   * ------------------------------------------------------- */
  digest: {
    headline: "TGS2026 展後 3 場目（09-23 09:00 場）。9 月 22 日夜から 9 月 23 日朝にかけて、日本国内向けの新作スマートフォンゲームの発表は確認されなかった。本場は展期内に取り落としていた日方主導の 2 件を補収し、翌日に迫った 9/24 の発売ラッシュに向けて既存作の情報を補完した。条目総数 132 → 134（手游区 33 で不変／主机・PC 区 108 → 110）",
    points: [
      "**手游侧は本場も日方の新規発表ゼロ**：9 月 22 日夜から 9 月 23 日朝にかけて、日本国内向けに発表された新作スマートフォンゲームは確認されなかった。日方側の動きは既存作の配信前準備に限られ、『BanG Dream! Our Notes』は 9/22 23:00（JST）から事前ダウンロードが進行中で、9/24 11:00（UTC+9）の世界同時配信を待つ段階にある（本場での追加更新はなし）。",
      "**翌 9/24 の発売ラッシュ前夜**：『SILENT HILL: Townfall』（コナミデジタルエンタテインメント、PS5／PC。デラックス版は 9/22 から 48 時間の先行アクセス中）、『刀剣乱舞 ぱずぎり』（合同会社EXNOA、iOS／Android／PC、事前登録 50 万突破）、『神貌之樹逆カバラ』（アークシステムワークス、PS5／Switch／PC）、Nintendo Switch 2 向けの『ドラゴンクエストXI S』などが同日に並ぶ。",
      "**主机・PC 侧は展期内の漏収 2 件を本場で補収**：①『狐ト蛙ノ旅 アダシノ島のコトロ鬼』（開発 リアス／発行 株式会社room6・yokaze、Nintendo Switch／PC。2022 年 6 月の Summer Game Fest「Day of the Devs」で発表済みのため既存企画として update 扱い。TGS2026 の room6 ブースで序章を追加した試遊版を出展）②『ガチ恋監禁♡めるてぃほりっく』（開発・発行 株式会社シリアルゲームズ＝東京都台東区、PC（Steam）、2027 年。TGS2025 で初公開済みのため update 扱い。Steam ストアページは 2026-09-03 に公開、TGS2026 で初のプレイアブル出展）。",
      "**既存条目の補完 1 条**：『刀剣乱舞 ぱずぎり』——開始時に実装される刀剣男士 42 振のうち希少枠 5 振（三日月宗近・歌仙兼定・一期一振・乱藤四郎・太郎太刀）、10-14 に第 2 章「一寸法師」着想の絵巻装束の追加実装、『刀剣乱舞ONLINE』連動キャンペーンでの新刀剣男士引換券（10-06 まで）を追記した。",
      "**漏収核查（IP・ブランド別に総当たり）**：チェンソーマン／呪術廻戦／ONE PIECE／BLEACH／鬼滅の刃／ブルーロック／東京リベンジャーズ／刀剣乱舞／ホロライブ／サンリオ／遊戯王／Otomate・LicoBiTs／東宝 TOHO Games／集英社ゲームズを順に確認。日方主導の新規漏収は上記 2 件（いずれも主机・PC 側）。『チェンソーマン』のスマホ新作は依然として開発元・発行元が未公表で資本帰属を判定できないため、从严のまま未収録を維持し次回以降に持ち越す。",
      "**中资の新作は引き続き全面的に跳过**：今期に確認された中国資本の開発・発行による新作（スマホ向けの大型タイトルを含む）は、開発・発行の資本帰属の判定によりすべて不収録とした。作品名・社名とも本站のデータには一切記載していない。",
      "**厂商名单と期待榜**：4 个 category の家数は 8／16／16／10＝50 で不変。extra は 34 家のまま（room6・SERIALGAMES はいずれもコンシューマー／PC 側の発行主体で、extra の「国内スマホ発行元」という口径に合致しないため追加しない）。Famitsu 期待榜は次号（9/24 発売号）まで新一期がなく、mostWanted は 9/17 号（投票期間 9/2〜9/8）の内容を据え置いた。"
    ]
  },
};
